...
# basePath = "D:/pizhou/pyCharmWorkSpaces/Statistics/resource/biluFile/"
#
# def loadNonstandard():
#     path = basePath+"biluFile/result/1/"
...
# # # load standard data
# def loadDict():
#     path = basePath+"biluFile/dataresource/UTF8/"
...
# def loadExtractInfo():
#     # # load nonstandard data
#     path = basePath+"biluFile/result/2/"
#     csv_extract_file = csv.reader(open(path + '/all.csv', 'r'))
#     extract_list = []
#     for i in csv_extract_file:
#         l = []
